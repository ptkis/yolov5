...
class LoadImagesAndLabels(Dataset):
    ...
    def __init__(
        ...
        if exists and LOCAL_RANK in {-1, 0}:
            ...
            tqdm(
                None, mininterval=300.0, desc=prefix + d, total=n, initial=n, bar_format=TQDM_BAR_FORMAT
        ...
        if cache_images:
            ...
            pbar = tqdm(
                results, total=len(self.indices), mininterval=300.0, bar_format=TQDM_BAR_FORMAT, disable=LOCAL_RANK > 0
            )
            for i, x in pbar:
